...
while True:
    ...
    p = subprocess.Popen(['gphoto2', '--set-config', 'eosremoterelease=2', '--wait-event=10s'])
    out = p.communicate()
    # Sleep during a 1s.
    sleep(1)
    ...
    s = subprocess.Popen(['gphoto2',"--num-files", "--folder=/store_00020001/DCIM/100CANON"], stdout=subprocess.PIPE)
    ...
    r = subprocess.Popen(['gphoto2',"--get-file="+p, "--folder=/store_00020001/DCIM/100CANON"])
    out = r.communicate()
